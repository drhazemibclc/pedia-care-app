...
export const VaccinationFindFirstOrThrowArgsSchema: z.ZodType<
	Omit<Prisma.VaccinationFindFirstOrThrowArgs, 'select' | 'include'>
> = z
	.object({
...
export default VaccinationFindFirstOrThrowArgsSchema
