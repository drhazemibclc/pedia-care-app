...
export const WHOGrowthStandardFindFirstArgsSchema: z.ZodType<
	Omit<Prisma.WHOGrowthStandardFindFirstArgs, 'select'>
> = z
	.object({
...
export default WHOGrowthStandardFindFirstArgsSchema
