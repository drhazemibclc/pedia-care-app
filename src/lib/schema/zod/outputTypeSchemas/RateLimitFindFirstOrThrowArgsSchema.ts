...
export const RateLimitFindFirstOrThrowArgsSchema: z.ZodType<
	Omit<Prisma.RateLimitFindFirstOrThrowArgs, 'select'>
> = z
	.object({
...
export default RateLimitFindFirstOrThrowArgsSchema
