...
export const WHOGrowthStandardFindManyArgsSchema: z.ZodType<
	Omit<Prisma.WHOGrowthStandardFindManyArgs, 'select'>
> = z
	.object({
...
export default WHOGrowthStandardFindManyArgsSchema
