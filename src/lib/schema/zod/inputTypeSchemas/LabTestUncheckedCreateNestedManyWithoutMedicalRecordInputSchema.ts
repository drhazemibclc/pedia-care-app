...
export const LabTestUncheckedCreateNestedManyWithoutMedicalRecordInputSchema: z.ZodType<Prisma.LabTestUncheckedCreateNestedManyWithoutMedicalRecordInput> =
	z
		.object({
			create: z
				.union([
...
export default LabTestUncheckedCreateNestedManyWithoutMedicalRecordInputSchema
