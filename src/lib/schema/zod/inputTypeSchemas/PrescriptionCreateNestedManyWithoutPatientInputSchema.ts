...
export const PrescriptionCreateNestedManyWithoutPatientInputSchema: z.ZodType<Prisma.PrescriptionCreateNestedManyWithoutPatientInput> =
	z
		.object({
			create: z
				.union([
...
export default PrescriptionCreateNestedManyWithoutPatientInputSchema
