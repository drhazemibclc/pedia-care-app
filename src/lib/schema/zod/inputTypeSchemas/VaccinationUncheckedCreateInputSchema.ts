...
export const VaccinationUncheckedCreateInputSchema: z.ZodType<Prisma.VaccinationUncheckedCreateInput> =
	z
		.object({
...
export default VaccinationUncheckedCreateInputSchema
