...
export const AppointmentCreateNestedManyWithoutServiceInputSchema: z.ZodType<Prisma.AppointmentCreateNestedManyWithoutServiceInput> =
	z
		.object({
			create: z
				.union([
...
export default AppointmentCreateNestedManyWithoutServiceInputSchema
