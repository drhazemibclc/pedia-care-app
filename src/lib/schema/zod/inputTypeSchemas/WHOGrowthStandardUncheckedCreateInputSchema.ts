...
export const WHOGrowthStandardUncheckedCreateInputSchema: z.ZodType<Prisma.WHOGrowthStandardUncheckedCreateInput> =
	z
		.object({
...
export default WHOGrowthStandardUncheckedCreateInputSchema
