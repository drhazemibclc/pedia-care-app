...
export const PatientUncheckedCreateWithoutVaccinationInputSchema: z.ZodType<Prisma.PatientUncheckedCreateWithoutVaccinationInput> =
	z
		.object({
			id: z.string(),
			firstName: z.string(),
...
export default PatientUncheckedCreateWithoutVaccinationInputSchema
