...
export const VaccinationUncheckedCreateNestedManyWithoutPatientInputSchema: z.ZodType<Prisma.VaccinationUncheckedCreateNestedManyWithoutPatientInput> =
	z
		.object({
			create: z
				.union([
...
export default VaccinationUncheckedCreateNestedManyWithoutPatientInputSchema
