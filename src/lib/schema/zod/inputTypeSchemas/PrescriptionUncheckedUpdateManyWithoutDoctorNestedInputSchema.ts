...
export const PrescriptionUncheckedUpdateManyWithoutDoctorNestedInputSchema: z.ZodType<Prisma.PrescriptionUncheckedUpdateManyWithoutDoctorNestedInput> =
	z
		.object({
			create: z
				.union([
...
export default PrescriptionUncheckedUpdateManyWithoutDoctorNestedInputSchema
