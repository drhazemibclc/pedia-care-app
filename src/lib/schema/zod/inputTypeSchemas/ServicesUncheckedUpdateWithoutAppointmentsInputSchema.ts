...
export const ServicesUncheckedUpdateWithoutAppointmentsInputSchema: z.ZodType<Prisma.ServicesUncheckedUpdateWithoutAppointmentsInput> =
	z
		.object({
...
export default ServicesUncheckedUpdateWithoutAppointmentsInputSchema
