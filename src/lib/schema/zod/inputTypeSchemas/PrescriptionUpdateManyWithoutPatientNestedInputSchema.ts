...
export const PrescriptionUpdateManyWithoutPatientNestedInputSchema: z.ZodType<Prisma.PrescriptionUpdateManyWithoutPatientNestedInput> =
	z
		.object({
			create: z
				.union([
...
export default PrescriptionUpdateManyWithoutPatientNestedInputSchema
