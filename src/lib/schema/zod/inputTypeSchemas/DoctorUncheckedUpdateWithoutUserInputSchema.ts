...
export const DoctorUncheckedUpdateWithoutUserInputSchema: z.ZodType<Prisma.DoctorUncheckedUpdateWithoutUserInput> =
	z
		.object({
...
export default DoctorUncheckedUpdateWithoutUserInputSchema
