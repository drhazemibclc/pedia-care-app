...
export const PrescriptionUpdateWithoutPatientInputSchema: z.ZodType<Prisma.PrescriptionUpdateWithoutPatientInput> =
	z
		.object({
			medicationName: z
...
export default PrescriptionUpdateWithoutPatientInputSchema
