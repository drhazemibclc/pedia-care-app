...
export const MedicalRecordsUncheckedUpdateWithoutLabTestInputSchema: z.ZodType<Prisma.MedicalRecordsUncheckedUpdateWithoutLabTestInput> =
	z
		.object({
...
export default MedicalRecordsUncheckedUpdateWithoutLabTestInputSchema
