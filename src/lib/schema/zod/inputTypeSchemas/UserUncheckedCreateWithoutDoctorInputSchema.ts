...
export const UserUncheckedCreateWithoutDoctorInputSchema: z.ZodType<Prisma.UserUncheckedCreateWithoutDoctorInput> =
	z
		.object({
			id: z.string(),
			name: z.string(),
...
export default UserUncheckedCreateWithoutDoctorInputSchema
