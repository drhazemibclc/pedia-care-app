...
import { StaffUpdateManyWithoutUserNestedInputSchema } from './StaffUpdateManyWithoutUserNestedInputSchema'
import { StringFieldUpdateOperationsInputSchema } from './StringFieldUpdateOperationsInputSchema'

export const UserUpdateWithoutPatientInputSchema: z.ZodType<Prisma.UserUpdateWithoutPatientInput> =
	z
		.object({
			...
			Staff: z.lazy(() => StaffUpdateManyWithoutUserNestedInputSchema).optional(),
			Doctor: z.lazy(() => DoctorUpdateManyWithoutUserNestedInputSchema).optional(),
		})
		.strict()

export default UserUpdateWithoutPatientInputSchema
