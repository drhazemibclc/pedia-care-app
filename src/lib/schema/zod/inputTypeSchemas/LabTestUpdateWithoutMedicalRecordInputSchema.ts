...
export const LabTestUpdateWithoutMedicalRecordInputSchema: z.ZodType<Prisma.LabTestUpdateWithoutMedicalRecordInput> =
	z
		.object({
			testDate: z
...
export default LabTestUpdateWithoutMedicalRecordInputSchema
