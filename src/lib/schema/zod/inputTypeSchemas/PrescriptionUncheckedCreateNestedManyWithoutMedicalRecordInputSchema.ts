...
export const PrescriptionUncheckedCreateNestedManyWithoutMedicalRecordInputSchema: z.ZodType<Prisma.PrescriptionUncheckedCreateNestedManyWithoutMedicalRecordInput> =
	z
		.object({
			create: z
				.union([
...
export default PrescriptionUncheckedCreateNestedManyWithoutMedicalRecordInputSchema
