...
export const VaccinationUncheckedUpdateManyWithoutPatientNestedInputSchema: z.ZodType<Prisma.VaccinationUncheckedUpdateManyWithoutPatientNestedInput> =
	z
		.object({
			create: z
				.union([
...
export default VaccinationUncheckedUpdateManyWithoutPatientNestedInputSchema
