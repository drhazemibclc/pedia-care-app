...
export const PatientUncheckedUpdateManyWithoutUserNestedInputSchema: z.ZodType<Prisma.PatientUncheckedUpdateManyWithoutUserNestedInput> =
	z
		.object({
			create: z
				.union([
...
export default PatientUncheckedUpdateManyWithoutUserNestedInputSchema
