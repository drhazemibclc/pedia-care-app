...
export const StaffUncheckedCreateNestedManyWithoutUserInputSchema: z.ZodType<Prisma.StaffUncheckedCreateNestedManyWithoutUserInput> =
	z
		.object({
			create: z
				.union([
...
export default StaffUncheckedCreateNestedManyWithoutUserInputSchema
