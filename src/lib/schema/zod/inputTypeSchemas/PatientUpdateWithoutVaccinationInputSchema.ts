...
export const PatientUpdateWithoutVaccinationInputSchema: z.ZodType<Prisma.PatientUpdateWithoutVaccinationInput> =
	z
		.object({
...
export default PatientUpdateWithoutVaccinationInputSchema
