...
export const WHOGrowthStandardUncheckedUpdateManyInputSchema: z.ZodType<Prisma.WHOGrowthStandardUncheckedUpdateManyInput> =
	z
		.object({
...
export default WHOGrowthStandardUncheckedUpdateManyInputSchema
