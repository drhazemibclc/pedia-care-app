...
export const PatientUpdateWithoutPrescriptionInputSchema: z.ZodType<Prisma.PatientUpdateWithoutPrescriptionInput> =
	z
		.object({
...
export default PatientUpdateWithoutPrescriptionInputSchema
