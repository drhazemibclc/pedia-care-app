...
export const VaccinationUncheckedCreateWithoutPatientInputSchema: z.ZodType<Prisma.VaccinationUncheckedCreateWithoutPatientInput> =
	z
		.object({
...
export default VaccinationUncheckedCreateWithoutPatientInputSchema
