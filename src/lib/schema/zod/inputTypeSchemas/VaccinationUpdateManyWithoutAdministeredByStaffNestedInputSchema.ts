...
export const VaccinationUpdateManyWithoutAdministeredByStaffNestedInputSchema: z.ZodType<Prisma.VaccinationUpdateManyWithoutAdministeredByStaffNestedInput> =
	z
		.object({
			create: z
				.union([
...
export default VaccinationUpdateManyWithoutAdministeredByStaffNestedInputSchema
