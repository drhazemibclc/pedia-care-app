...
export const WHOGrowthStandardAvgOrderByAggregateInputSchema: z.ZodType<Prisma.WHOGrowthStandardAvgOrderByAggregateInput> =
	z
		.object({
...
export default WHOGrowthStandardAvgOrderByAggregateInputSchema
