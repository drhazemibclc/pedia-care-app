...
export const PrescriptionCountOrderByAggregateInputSchema: z.ZodType<Prisma.PrescriptionCountOrderByAggregateInput> =
	z
		.object({
...
export default PrescriptionCountOrderByAggregateInputSchema
