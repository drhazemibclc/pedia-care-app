...
export const MedicalRecordsCreateWithoutPrescriptionInputSchema: z.ZodType<Prisma.MedicalRecordsCreateWithoutPrescriptionInput> =
	z
		.object({
			doctorId: z.string(),
...
export default MedicalRecordsCreateWithoutPrescriptionInputSchema
