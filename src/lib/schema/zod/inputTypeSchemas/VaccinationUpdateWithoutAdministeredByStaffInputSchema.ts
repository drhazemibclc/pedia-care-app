...
export const VaccinationUpdateWithoutAdministeredByStaffInputSchema: z.ZodType<Prisma.VaccinationUpdateWithoutAdministeredByStaffInput> =
	z
		.object({
			vaccineName: z
...
export default VaccinationUpdateWithoutAdministeredByStaffInputSchema
