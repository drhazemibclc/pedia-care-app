...
export const VaccinationCountOrderByAggregateInputSchema: z.ZodType<Prisma.VaccinationCountOrderByAggregateInput> =
	z
		.object({
...
export default VaccinationCountOrderByAggregateInputSchema
