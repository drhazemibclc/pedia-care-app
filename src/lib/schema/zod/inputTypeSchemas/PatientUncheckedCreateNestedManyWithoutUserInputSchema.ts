...
export const PatientUncheckedCreateNestedManyWithoutUserInputSchema: z.ZodType<Prisma.PatientUncheckedCreateNestedManyWithoutUserInput> =
	z
		.object({
			create: z
				.union([
...
export default PatientUncheckedCreateNestedManyWithoutUserInputSchema
