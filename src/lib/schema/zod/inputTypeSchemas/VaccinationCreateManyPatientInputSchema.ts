...
export const VaccinationCreateManyPatientInputSchema: z.ZodType<Prisma.VaccinationCreateManyPatientInput> =
	z
		.object({
...
export default VaccinationCreateManyPatientInputSchema
