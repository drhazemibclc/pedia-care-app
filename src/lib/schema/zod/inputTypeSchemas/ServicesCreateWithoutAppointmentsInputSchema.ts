...
export const ServicesCreateWithoutAppointmentsInputSchema: z.ZodType<Prisma.ServicesCreateWithoutAppointmentsInput> =
	z
		.object({
...
export default ServicesCreateWithoutAppointmentsInputSchema
