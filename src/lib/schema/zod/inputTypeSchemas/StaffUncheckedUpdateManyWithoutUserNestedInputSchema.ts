...
export const StaffUncheckedUpdateManyWithoutUserNestedInputSchema: z.ZodType<Prisma.StaffUncheckedUpdateManyWithoutUserNestedInput> =
	z
		.object({
			create: z
				.union([
...
export default StaffUncheckedUpdateManyWithoutUserNestedInputSchema
