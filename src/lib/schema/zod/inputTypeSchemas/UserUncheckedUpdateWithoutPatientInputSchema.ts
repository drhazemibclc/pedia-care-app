...
export const UserUncheckedUpdateWithoutPatientInputSchema: z.ZodType<Prisma.UserUncheckedUpdateWithoutPatientInput> =
	z
		.object({
...
export default UserUncheckedUpdateWithoutPatientInputSchema
