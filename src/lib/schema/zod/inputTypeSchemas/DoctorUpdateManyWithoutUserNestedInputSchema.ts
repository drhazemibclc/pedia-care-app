...
export const DoctorUpdateManyWithoutUserNestedInputSchema: z.ZodType<Prisma.DoctorUpdateManyWithoutUserNestedInput> =
	z
		.object({
			create: z
				.union([
...
export default DoctorUpdateManyWithoutUserNestedInputSchema
