...
export const DoctorUpdateWithoutPrescriptionInputSchema: z.ZodType<Prisma.DoctorUpdateWithoutPrescriptionInput> =
	z
		.object({
...
export default DoctorUpdateWithoutPrescriptionInputSchema
