...
export const WHOGrowthStandardCountOrderByAggregateInputSchema: z.ZodType<Prisma.WHOGrowthStandardCountOrderByAggregateInput> =
	z
		.object({
...
export default WHOGrowthStandardCountOrderByAggregateInputSchema
