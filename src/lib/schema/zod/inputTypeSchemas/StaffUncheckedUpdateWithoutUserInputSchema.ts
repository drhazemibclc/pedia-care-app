...
export const StaffUncheckedUpdateWithoutUserInputSchema: z.ZodType<Prisma.StaffUncheckedUpdateWithoutUserInput> =
	z
		.object({
...
export default StaffUncheckedUpdateWithoutUserInputSchema
