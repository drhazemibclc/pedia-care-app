...
export const PatientUncheckedUpdateWithoutPrescriptionInputSchema: z.ZodType<Prisma.PatientUncheckedUpdateWithoutPrescriptionInput> =
	z
		.object({
...
export default PatientUncheckedUpdateWithoutPrescriptionInputSchema
