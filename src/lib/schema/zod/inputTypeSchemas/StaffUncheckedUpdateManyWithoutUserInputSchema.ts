...
export const StaffUncheckedUpdateManyWithoutUserInputSchema: z.ZodType<Prisma.StaffUncheckedUpdateManyWithoutUserInput> =
	z
		.object({
...
export default StaffUncheckedUpdateManyWithoutUserInputSchema
