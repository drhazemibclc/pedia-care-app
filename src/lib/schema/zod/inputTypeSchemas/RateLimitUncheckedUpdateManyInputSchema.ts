...
export const RateLimitUncheckedUpdateManyInputSchema: z.ZodType<Prisma.RateLimitUncheckedUpdateManyInput> =
	z
		.object({
...
export default RateLimitUncheckedUpdateManyInputSchema
