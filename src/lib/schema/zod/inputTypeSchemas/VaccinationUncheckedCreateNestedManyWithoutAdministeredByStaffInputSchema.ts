...
export const VaccinationUncheckedCreateNestedManyWithoutAdministeredByStaffInputSchema: z.ZodType<Prisma.VaccinationUncheckedCreateNestedManyWithoutAdministeredByStaffInput> =
	z
		.object({
			create: z
				.union([
...
export default VaccinationUncheckedCreateNestedManyWithoutAdministeredByStaffInputSchema
