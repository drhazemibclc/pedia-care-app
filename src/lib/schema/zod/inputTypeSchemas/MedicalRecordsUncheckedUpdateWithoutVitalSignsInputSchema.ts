...
export const MedicalRecordsUncheckedUpdateWithoutVitalSignsInputSchema: z.ZodType<Prisma.MedicalRecordsUncheckedUpdateWithoutVitalSignsInput> =
	z
		.object({
...
export default MedicalRecordsUncheckedUpdateWithoutVitalSignsInputSchema
