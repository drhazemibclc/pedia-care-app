...
export const MedicalRecordsUncheckedCreateWithoutVitalSignsInputSchema: z.ZodType<Prisma.MedicalRecordsUncheckedCreateWithoutVitalSignsInput> =
	z
		.object({
...
export default MedicalRecordsUncheckedCreateWithoutVitalSignsInputSchema
