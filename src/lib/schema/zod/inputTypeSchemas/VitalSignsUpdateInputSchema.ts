...
import { MedicalRecordsUpdateOneRequiredWithoutVitalSignsNestedInputSchema } from './MedicalRecordsUpdateOneRequiredWithoutVitalSignsNestedInputSchema'
...
export const VitalSignsUpdateInputSchema: z.ZodType<Prisma.VitalSignsUpdateInput> = z
	.object({
		...
		updatedAt: z
			...
			.optional(),
		medical: z
			.lazy(() => MedicalRecordsUpdateOneRequiredWithoutVitalSignsNestedInputSchema)
			.optional(),
	})
	.strict()
