...
export const DoctorUncheckedUpdateWithoutPrescriptionInputSchema: z.ZodType<Prisma.DoctorUncheckedUpdateWithoutPrescriptionInput> =
	z
		.object({
...
export default DoctorUncheckedUpdateWithoutPrescriptionInputSchema
