...
export const AppointmentUpdateManyWithoutServiceNestedInputSchema: z.ZodType<Prisma.AppointmentUpdateManyWithoutServiceNestedInput> =
	z
		.object({
			create: z
				.union([
...
export default AppointmentUpdateManyWithoutServiceNestedInputSchema
