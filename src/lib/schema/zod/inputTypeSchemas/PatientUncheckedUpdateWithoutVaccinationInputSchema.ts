...
export const PatientUncheckedUpdateWithoutVaccinationInputSchema: z.ZodType<Prisma.PatientUncheckedUpdateWithoutVaccinationInput> =
	z
		.object({
...
export default PatientUncheckedUpdateWithoutVaccinationInputSchema
