...
export const PrescriptionUpdateManyWithoutMedicalRecordNestedInputSchema: z.ZodType<Prisma.PrescriptionUpdateManyWithoutMedicalRecordNestedInput> =
	z
		.object({
			create: z
				.union([
...
export default PrescriptionUpdateManyWithoutMedicalRecordNestedInputSchema
