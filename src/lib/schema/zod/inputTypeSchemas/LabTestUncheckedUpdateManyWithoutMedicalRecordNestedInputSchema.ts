...
export const LabTestUncheckedUpdateManyWithoutMedicalRecordNestedInputSchema: z.ZodType<Prisma.LabTestUncheckedUpdateManyWithoutMedicalRecordNestedInput> =
	z
		.object({
			create: z
				.union([
...
export default LabTestUncheckedUpdateManyWithoutMedicalRecordNestedInputSchema
