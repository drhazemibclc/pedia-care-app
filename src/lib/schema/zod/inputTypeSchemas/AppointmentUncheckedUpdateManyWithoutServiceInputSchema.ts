...
export const AppointmentUncheckedUpdateManyWithoutServiceInputSchema: z.ZodType<Prisma.AppointmentUncheckedUpdateManyWithoutServiceInput> =
	z
		.object({
...
export default AppointmentUncheckedUpdateManyWithoutServiceInputSchema
