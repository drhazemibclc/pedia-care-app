...
export const PrescriptionUncheckedCreateNestedManyWithoutDoctorInputSchema: z.ZodType<Prisma.PrescriptionUncheckedCreateNestedManyWithoutDoctorInput> =
	z
		.object({
			create: z
				.union([
...
export default PrescriptionUncheckedCreateNestedManyWithoutDoctorInputSchema
