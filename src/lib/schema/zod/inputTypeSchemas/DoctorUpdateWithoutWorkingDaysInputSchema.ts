...
export const DoctorUpdateWithoutWorkingDaysInputSchema: z.ZodType<Prisma.DoctorUpdateWithoutWorkingDaysInput> =
	z
		.object({
...
export default DoctorUpdateWithoutWorkingDaysInputSchema
