...
export const VaccinationMinOrderByAggregateInputSchema: z.ZodType<Prisma.VaccinationMinOrderByAggregateInput> =
	z
		.object({
...
export default VaccinationMinOrderByAggregateInputSchema
