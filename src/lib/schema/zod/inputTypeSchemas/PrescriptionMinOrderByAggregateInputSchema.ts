...
export const PrescriptionMinOrderByAggregateInputSchema: z.ZodType<Prisma.PrescriptionMinOrderByAggregateInput> =
	z
		.object({
...
export default PrescriptionMinOrderByAggregateInputSchema
