...
export const PatientUncheckedUpdateWithoutUserInputSchema: z.ZodType<Prisma.PatientUncheckedUpdateWithoutUserInput> =
	z
		.object({
...
export default PatientUncheckedUpdateWithoutUserInputSchema
