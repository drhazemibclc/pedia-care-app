...
export const PrescriptionUpdateWithoutMedicalRecordInputSchema: z.ZodType<Prisma.PrescriptionUpdateWithoutMedicalRecordInput> =
	z
		.object({
			medicationName: z
...
export default PrescriptionUpdateWithoutMedicalRecordInputSchema
