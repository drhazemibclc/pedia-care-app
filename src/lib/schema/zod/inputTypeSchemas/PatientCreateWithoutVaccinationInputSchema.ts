...
export const PatientCreateWithoutVaccinationInputSchema: z.ZodType<Prisma.PatientCreateWithoutVaccinationInput> =
	z
		.object({
			id: z.string(),
			firstName: z.string(),
...
export default PatientCreateWithoutVaccinationInputSchema
