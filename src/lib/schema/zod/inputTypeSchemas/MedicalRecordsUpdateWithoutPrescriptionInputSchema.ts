...
export const MedicalRecordsUpdateWithoutPrescriptionInputSchema: z.ZodType<Prisma.MedicalRecordsUpdateWithoutPrescriptionInput> =
	z
		.object({
			doctorId: z
...
export default MedicalRecordsUpdateWithoutPrescriptionInputSchema
