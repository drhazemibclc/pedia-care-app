...
export const WHOGrowthStandardMaxOrderByAggregateInputSchema: z.ZodType<Prisma.WHOGrowthStandardMaxOrderByAggregateInput> =
	z
		.object({
...
export default WHOGrowthStandardMaxOrderByAggregateInputSchema
