...
export const MedicalRecordsUncheckedUpdateWithoutPrescriptionInputSchema: z.ZodType<Prisma.MedicalRecordsUncheckedUpdateWithoutPrescriptionInput> =
	z
		.object({
...
export default MedicalRecordsUncheckedUpdateWithoutPrescriptionInputSchema
