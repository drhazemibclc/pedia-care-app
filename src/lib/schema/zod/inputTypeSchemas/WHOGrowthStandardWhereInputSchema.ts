...
export const WHOGrowthStandardWhereInputSchema: z.ZodType<Prisma.WHOGrowthStandardWhereInput> = z
	.object({
		AND: z
			.union([
		...
		ageInMonths: z.union([z.lazy(() => IntFilterSchema), z.number()]).optional(),
		gender: z.union([z.lazy(() => EnumGenderFilterSchema), z.lazy(() => GenderSchema)]).optional(),
		measurementType: z
			.union([z.lazy(() => EnumMeasurementTypeFilterSchema), z.lazy(() => MeasurementTypeSchema)])
			.optional(),
...
export default WHOGrowthStandardWhereInputSchema
