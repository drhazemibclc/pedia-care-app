...
export const WHOGrowthStandardUpdateManyMutationInputSchema: z.ZodType<Prisma.WHOGrowthStandardUpdateManyMutationInput> =
	z
		.object({
			ageInMonths: z
...
export default WHOGrowthStandardUpdateManyMutationInputSchema
