...
export const MedicalRecordsUpdateWithoutLabTestInputSchema: z.ZodType<Prisma.MedicalRecordsUpdateWithoutLabTestInput> =
	z
		.object({
			doctorId: z
...
export default MedicalRecordsUpdateWithoutLabTestInputSchema
