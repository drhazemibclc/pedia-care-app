...
export const DoctorCreateWithoutWorkingDaysInputSchema: z.ZodType<Prisma.DoctorCreateWithoutWorkingDaysInput> =
	z
		.object({
			id: z.string(),
			email: z.string(),
...
export default DoctorCreateWithoutWorkingDaysInputSchema
