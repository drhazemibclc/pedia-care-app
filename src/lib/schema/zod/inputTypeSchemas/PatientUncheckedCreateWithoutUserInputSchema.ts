...
export const PatientUncheckedCreateWithoutUserInputSchema: z.ZodType<Prisma.PatientUncheckedCreateWithoutUserInput> =
	z
		.object({
			id: z.string(),
			firstName: z.string(),
...
export default PatientUncheckedCreateWithoutUserInputSchema
