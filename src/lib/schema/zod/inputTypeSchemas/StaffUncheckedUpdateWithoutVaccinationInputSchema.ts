...
export const StaffUncheckedUpdateWithoutVaccinationInputSchema: z.ZodType<Prisma.StaffUncheckedUpdateWithoutVaccinationInput> =
	z
		.object({
...
export default StaffUncheckedUpdateWithoutVaccinationInputSchema
