...
export const DoctorCreateNestedManyWithoutUserInputSchema: z.ZodType<Prisma.DoctorCreateNestedManyWithoutUserInput> =
	z
		.object({
			create: z
				.union([
...
export default DoctorCreateNestedManyWithoutUserInputSchema
