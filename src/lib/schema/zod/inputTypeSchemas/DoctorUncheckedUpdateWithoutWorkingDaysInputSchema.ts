...
export const DoctorUncheckedUpdateWithoutWorkingDaysInputSchema: z.ZodType<Prisma.DoctorUncheckedUpdateWithoutWorkingDaysInput> =
	z
		.object({
...
export default DoctorUncheckedUpdateWithoutWorkingDaysInputSchema
