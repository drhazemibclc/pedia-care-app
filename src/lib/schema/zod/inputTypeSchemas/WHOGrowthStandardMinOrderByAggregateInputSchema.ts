...
export const WHOGrowthStandardMinOrderByAggregateInputSchema: z.ZodType<Prisma.WHOGrowthStandardMinOrderByAggregateInput> =
	z
		.object({
...
export default WHOGrowthStandardMinOrderByAggregateInputSchema
