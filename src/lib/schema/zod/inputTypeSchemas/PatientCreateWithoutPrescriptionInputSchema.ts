...
export const PatientCreateWithoutPrescriptionInputSchema: z.ZodType<Prisma.PatientCreateWithoutPrescriptionInput> =
	z
		.object({
			id: z.string(),
			firstName: z.string(),
...
export default PatientCreateWithoutPrescriptionInputSchema
