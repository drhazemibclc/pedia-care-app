...
export const DoctorUncheckedCreateWithoutWorkingDaysInputSchema: z.ZodType<Prisma.DoctorUncheckedCreateWithoutWorkingDaysInput> =
	z
		.object({
			id: z.string(),
			email: z.string(),
...
export default DoctorUncheckedCreateWithoutWorkingDaysInputSchema
