...
export const DoctorUncheckedCreateWithoutUserInputSchema: z.ZodType<Prisma.DoctorUncheckedCreateWithoutUserInput> =
	z
		.object({
			id: z.string(),
			email: z.string(),
...
export default DoctorUncheckedCreateWithoutUserInputSchema
